...
public class ThirdPersonCamera : MonoBehaviour {
    ...
    void CameraMovement() {
        ...
        Invector.ClipPlanePoints planePoints = Invector.vExtensions.NearClipPlanePoints(_camera, current_cPos + (camDir * (distance)), clipPlaneMargin);
        Invector.ClipPlanePoints oldPoints = Invector.vExtensions.NearClipPlanePoints(_camera, desired_cPos + (camDir * distance), clipPlaneMargin);
    ...
    /// <returns></returns>
    bool CullingRayCast(Vector3 from, Invector.ClipPlanePoints _to, out RaycastHit hitInfo, float distance, LayerMask cullingLayer, Color color) {
        bool value = false;
